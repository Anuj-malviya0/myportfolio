...
const ProfileText = ({ visible, titleId }) => (
  <Fragment>
    ...
    <Text className={styles.description} data-visible={visible} size="l" as="p">
      I’m Anuj, currently I am currentlya a Undergraduate student at {' '}
      <Link href="https://www.ietdavv.edu.in/">IET</Link>. My projects include Python Automations, Machine
